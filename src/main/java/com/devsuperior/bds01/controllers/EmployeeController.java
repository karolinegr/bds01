...
public class EmployeeController {
    ...
    public ResponseEntity<Page<EmployeeDTO>> findAll(Pageable pageable) {
        ...
        Page<EmployeeDTO> findAllPaged = this.employeeService.findAllPaged(pageRequest);
    ...
    public ResponseEntity<EmployeeDTO> insert(
        ...
        EmployeeDTO newEmployeeDTO = this.employeeService.insert(newEmployee);
        URI uri = ServletUriComponentsBuilder.fromCurrentRequest()
                .path("/{id}").buildAndExpand(newEmployeeDTO.getId()).toUri();
